...
<section class="header_main fadeInLeft">
    ...
    <article class="header_main__left ">
        <h2 role="heading" aria-level="2" id="title" class="main-title"
            itemprop="name"><?= esc_html(get_field('author')) ?></h2>
    ...
    <article class="header_main__right folder ">
        ...
        <figure class="folder__figure">
            ...
            <svg class="folder__pin" data-name="folder__pin" xmlns="http://www.w3.org/2000/svg"
...
<section class="project-card ">
    <h2 class="project-card__sub-title" data-showup="true"><?= esc_html(get_field('projects_sub_title')) ?></h2>
